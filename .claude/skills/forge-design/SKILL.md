...
**`.claude/DESIGN.md`** — in full, before writing or planning any UI code. It is binding, ~400 lines,
...
| File | Read it when |
|---|---|
| `.claude/design/MAP.md` | "what already exists?" / "why is this here?" |
| `.claude/design/SETTLED.md` | **before re-adding anything that feels missing** — most obvious improvements were already tried and cut. Also holds the open contrast decisions. |
| `.claude/design/FAILURES.md` | a layout feels off and you want the named diagnosis |
| `.claude/design/AUDIT.md` | picking up doctrine debt |
| `.claude/design/DECISIONS.md` | why a rule exists, or why it changed |
| `.claude/design/WEAR.md` | touching `:wear` only |
