...
object ExerciseLibrary {
    ...
    val all: List<ExerciseDef> = listOf(
        ...
        ExerciseDef("db-bulgarian-split-squat", "DB Bulgarian Split Squat", MuscleGroup.QUADS,
            ...
            whenToUse = "Light DBs work great here. Hard to balance at first, give it 2-3 sessions."),
        ...
        ExerciseDef("bw-doorframe-curl", "Doorframe Curl", MuscleGroup.BICEPS,
            ...
            whenToUse = "Bodyweight only. Use it when you have no dumbbells or bar.",
            fallbackOnly = true),
        ...
        ExerciseDef("barbell-bench-press", "Barbell Bench Press", MuscleGroup.CHEST,
            ...
            muscleTarget = "Whole chest · heaviest pressing option",
        ...
        ExerciseDef("seated-leg-curl", "Seated Leg Curl", MuscleGroup.HAMSTRINGS,
            ...
            muscleTarget = "Hamstrings (stretched at the hip, so the seated version works them longer)",
            why = "The other leg-curl station. Sitting keeps the hamstrings stretched at the hip, which the lying version can't. It also gives a second leg day its own curl instead of another deadlift.",
