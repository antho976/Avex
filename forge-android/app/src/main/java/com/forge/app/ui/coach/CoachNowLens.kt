...
// The Academy link that closed this lens is gone (2026-07-27): the knowledge half of the coach is
// its own tab now, so a link from a sibling tab is redundant navigation (§4.2).
